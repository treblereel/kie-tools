...
@Dependent
@SWEditor
public class SWToolboxControl extends AbstractToolboxControl {
    ...
    @Inject
    public SWToolboxControl(final @Any @FlowActionsToolbox ManagedInstance<ActionsToolboxFactory> flowActionsToolboxFactories,
