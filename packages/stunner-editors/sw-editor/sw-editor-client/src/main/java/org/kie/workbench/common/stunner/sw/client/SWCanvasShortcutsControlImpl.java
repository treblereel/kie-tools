...
@SWEditor
@Dependent
public class SWCanvasShortcutsControlImpl extends AbstractCanvasShortcutsControlImpl {

    @Inject
    public SWCanvasShortcutsControlImpl(final @SWEditor ManagedInstance<KeyboardShortcut> implementedActions) {
