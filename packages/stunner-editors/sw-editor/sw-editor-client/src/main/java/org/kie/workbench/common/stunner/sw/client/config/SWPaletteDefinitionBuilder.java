...
import org.kie.workbench.common.stunner.sw.definition.SWCategories;

@Dependent
@SWEditor
public class SWPaletteDefinitionBuilder
    ...
    // CDI proxy.
    protected SWPaletteDefinitionBuilder() {
        this(null);
    }

    @Inject
    public SWPaletteDefinitionBuilder(final CollapsedPaletteDefinitionBuilder paletteDefinitionBuilder) {
