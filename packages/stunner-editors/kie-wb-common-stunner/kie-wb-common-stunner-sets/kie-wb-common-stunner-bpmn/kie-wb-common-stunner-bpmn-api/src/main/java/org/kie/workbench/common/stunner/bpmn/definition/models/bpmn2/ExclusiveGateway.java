...
@XmlRootElement(name = "exclusiveGateway", namespace = "http://www.omg.org/spec/BPMN/20100524/MODEL")
public class ExclusiveGateway extends BaseGateway {
    ...
    */
    ...
    /*
      Exclusive Gateway support only Diverging and Converging
    */
    @Override
    public String getGatewayDirection() {
        if ("Diverging".equals(super.getGatewayDirection())
                || "Converging".equals(super.getGatewayDirection())) {
            return super.getGatewayDirection();
        }
