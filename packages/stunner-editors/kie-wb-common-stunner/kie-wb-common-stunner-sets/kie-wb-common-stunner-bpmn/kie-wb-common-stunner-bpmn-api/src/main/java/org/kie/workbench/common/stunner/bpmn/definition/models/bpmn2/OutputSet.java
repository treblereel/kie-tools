...
public class OutputSet {
    ...
    @XmlElement(name = "dataOutputRefs")
    @XmlUnwrappedCollection
    private List<DataOutputRefs> dataOutputRefs = new ArrayList<>();
    ...
    public boolean equals(Object o) {
        ...
        OutputSet outputSet = (OutputSet) o;
        return Objects.equals(getDataOutputRefs(), outputSet.getDataOutputRefs());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getDataOutputRefs());
    }
}
