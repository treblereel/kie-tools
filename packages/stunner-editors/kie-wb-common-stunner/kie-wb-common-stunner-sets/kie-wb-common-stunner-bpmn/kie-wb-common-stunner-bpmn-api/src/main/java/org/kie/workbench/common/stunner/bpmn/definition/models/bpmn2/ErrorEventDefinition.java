...
public class ErrorEventDefinition extends AbstractEventDefinition {
    ...
    public ErrorEventDefinition(String droolserefName, String errorRef) {
        this.erefname = droolserefName;
    ...
    public void setErefname(String erefname) {
        this.erefname = erefname;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getErefname(), that.getErefname())
                && Objects.equals(getErrorRef(), that.getErefname());
    }

    @Override
    public int hashCode() {
        return HashUtil.combineHashCodes(Objects.hashCode(erefname),
